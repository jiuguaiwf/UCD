...
from qm9.dataset import resolve_geom_data_file
...
data_file = resolve_geom_data_file()
...
def main():
    ...
    if args.ema_decay > 0:
        model_ema, _, _ = get_latent_diffusion(args, device, dataset_info, dataloaders['train'])  # create a new model
    ...
    for epoch in range(args.start_epoch, args.n_epochs):
        ...
        if epoch % args.test_epochs == 0:
            validity_dict, rdkit_metrics = ldm_train_test.analyze_and_save(epoch, model_ema, nodes_dist, args, device,
            ...
            nll_test = ldm_train_test.test(args, dataloaders['test'], epoch, model_ema_dp, device, dtype,
