...
if args.resume is not None:
    ...
    set_bs = args.batch_size

    with open(join(args.resume, 'args.pickle'), 'rb') as f:
        args = pickle.load(f)

    args.batch_size = set_bs
    args.resume = resume
    args.n_epochs = end_epoch
...
def main():
    ...
    for epoch in range(args.start_epoch, args.n_epochs):
        ...
        if epoch % args.test_epochs == 0:
            ...
            if validity_dict['mol_stable'] > best_mol_stability:
                best_mol_stability = validity_dict['mol_stable']
                if args.save_model:
